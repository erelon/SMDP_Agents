...
GROUP_NAMES = {
    ...
    "ExampleEnvContractTests": "Example envs / contract",
    "CriterionEnvTests": "Example envs / criteria",
    "RiskEnvTests": "Example envs / risk",
    "DriftEnvTests": "Example envs / drift",
    "RateEnvTests": "Example envs / rates",
    "MarketEnvTests": "Example envs / market",
    "AgentConstructionTests": "Example runner / agents",
    "TrainingLoopTests": "Example runner / training",
    "JobTests": "Example runner / jobs",
    "ReportAggregationTests": "Example report",
    "PlotTests": "Example plots",
    "SourceSettingsTests": "Example source settings",
    "WorkerPoolTests": "Example worker pool",
    "CorrectActionTableTests": "Example correct actions",
    "SincoslogCorrectActionTests": "Example correct actions / sincoslog",
    "WhackAMoleEnvTests": "Example envs / whack-a-mole",
    "TabularEnvTests": "Example envs / tabular",
    "TwoPathEnvTests": "Example envs / two-path",
}
